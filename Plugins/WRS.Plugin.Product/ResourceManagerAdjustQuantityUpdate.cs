...
{
    public class ResourceManagerAdjustQuantityUpdate : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            if (context.InputParameters.Contains("Target") && context.InputParameters["Target"] is Entity)
            {
                ...
                try
                {
                    ...
                    if (targetEntity.Contains("wrs_quantity"))
                    {
                        ...
                        if (targetEntity.Contains("wrs_quantity"))
                        {
                            ...
                            requestEntity.RequestType = "AdjustRMEventStockQuantity";
                            var preQuantity = preImage.GetAttributeValue<int>("wrs_quantity");
                            var postQuantity = targetEntity.GetAttributeValue<int>("wrs_quantity");
                            requestEntity.AdjustQuantity = postQuantity - preQuantity;
                        }                                               
